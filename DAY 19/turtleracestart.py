...
userInput = screen.textinput(title="Make your bet", prompt="Which turle will win the race? Enter a color:  ['Red','orange','yellow','green','blue','purple']")
    ...
    for turtle in allTurtles:
        if turtle.xcor() > 230:
            ...
            if winningColor == userInput:
                turtle.write(f"You have won! The {winningColor} turtle is the winner!")
            else:
